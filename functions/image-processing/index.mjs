...
export const handler = async (event) => {
  ...
  try {
    ...
    if (operationsJSON["format"]) {
      ...
      // If not format is specified, Sharp converts svg to png by default
  ...
  // Return error if the image is too big and a redirection was not possible, else return transformed image
  if (imageTooBig) {
